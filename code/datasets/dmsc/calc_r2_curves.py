...
if __name__ == "__main__":
    ...
    models = {
        ...
        # ),
        "VC": VCregression(seq_length=9, alphabet_type="rna"),
        "CN": ConnectednessModelRegression(seq_length=9, alphabet_type="rna"),
        "LER": LocalEpistasisRegression(seq_length=9, alphabet_type="rna", P=2),
    }
    ...
    results = []
    for p in np.geomspace(0.5, 0.99, 10):
