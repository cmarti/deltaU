...
from code.plot_utils import FIG_WIDTH, apply_plot_style, arrange_axis, POSITION_LABELS
...
if __name__ == "__main__":
    ...
    dsg = dplot.plot_edges(nodes_df, edges_df=edges_df, resolution=800, x=x, y=y)
    ...
    for i, (xlims, ylims) in enumerate(boxes):
        ...
        seqs = get_genotypes_from_region(
            nodes_df,
            min_values={x: xlims[0], y: ylims[0]},
