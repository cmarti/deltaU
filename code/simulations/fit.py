...
if __name__ == "__main__":
    ...
    print("Making predictions for the complete landscape...")
    pred = model.predict()

    print("Saving model predictions...")
    pred.to_csv("results/simulations.pred.csv")
    ...
    test = test.loc[X_test, :].join(pred, rsuffix="pred")

    print("Saving model predictions on test set...")
    test.to_csv("results/simulations.test_pred.csv")
    print("Done.")
