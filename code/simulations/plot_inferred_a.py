...
if __name__ == "__main__":
    ...
    print("Loading data...")
    a_matrix = pd.read_csv('results/simulations.inferred_interaction_strength.csv', index_col=0)

    print("Making figure...")
    fig, axes = plt.subplots(1, 1, figsize=(0.33*FIG_WIDTH, 0.5 * 0.55 * FIG_WIDTH))
    ...
    fig.savefig("figures/simulations_inferred_a_matrix.png", dpi=300)
    print("Done.")
